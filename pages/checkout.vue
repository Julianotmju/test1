        ...
        <div class="md:w-[65%]">
            <div class="bg-white rounded-lg p-4">
                ...
                <NuxtLink 
                    v-else
                    to="/address"
                    class="flex items-center text-blue-500 hover:bg-amber-500"
                >
                    <Icon name="mdi:plus" size="18" class="mr-2"/>
        ...
        <div class="md:w-[35%]">
            <div id="PlaceOrder" class="bg-white rounded-lg p-4">
                ...
                <div class="flex items-center justify-between my-4">
                    <div class="">Custo de envio</div>
                    <div class="">Grátis</div>
                </div>
                ...
                <form @submit.prevent="pay()">
                    ...
                    <p 
                        id="card-error" 
                        role="alert" 
                        class="bg-amber-500 text-center font-semibold" 
                    />
                    ...
                    >
                        ...
                        <div v-else>Faça a encomenda</div>
                    </button>
                </form>

            </div>
            <div class="bg-white rounded-lg p-4 mt-4">
                <div class="text-lg font-semibold mb-2 mt-2">Flexdesign</div>
                <p class="my-2">
                    A Flexdesign mantém suas informações e pagamentos seguros
                </p>
